            ...
            <div class="container-fluid shadow-lg bg-body rounded p-5 h-100">
                <div class="border-bottom row align-items-center mb-5 py-3">
                    <div class="col-10">
                        ...
                        if (isset($_GET['stat'])) {
                            $stat = $_GET['stat'];
                            $pageTitle = "Official Business - $stat";
                            if ($_GET['stat'] == 'Pending') {
                                $list = $officialBusinessPendingList;
                            } elseif ($_GET['stat'] == 'Approved') {
                                $list = $officialBusinessApprovedList;
                            } elseif ($_GET['stat'] == 'Disapproved') {
                                $list = $officialBusinessDisapprovedList;
                            }
                        }
                        ...
                        <table id="table" class="table table-borderless table-striped">
                            ...
                            <tbody>
                                <?php foreach ($list as $item) {
                                    ...
                                    echo '<tr>';
                                    echo '<th scope="row">
                                            <a href="../php/officialBusinessData.php?status=' . $_GET['stat'] . '&id=' . $id . '">
